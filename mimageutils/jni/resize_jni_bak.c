...
#ifndef _Included_com_aspire_mao_Mjpeg
#define _Included_com_aspire_mao_Mjpeg
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: ([BII)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_aspirecn_hawaii_jpeg_JpegToolKit_resize
(JNIEnv *env, jclass cls, jbyteArray array, jint size, jint quality) {
	...
	jsize dst_size = 0;
	jbyte* dst = (jbyte *)aspire_mao_resize_jpg((unsigned long *)&dst_size, (unsigned char*)src, (unsigned long)src_size, (int)size, (int)quality);
